...
const createJob = async (req, res) => {
  const { images, company } = req.body

  // req.body.images.push(
  //   { url: 'http://localhost:5000/uploads/adept1.jpg' },
  //   { url: 'http://localhost:5000/uploads/adept1.jpg' },
  //   { url: 'http://localhost:5000/uploads/adept1.jpg' }
  // )
...
export { createJob, deleteJob, getAllJobs, getAllProducts, updateJob, showStats,updateJobs, updateAllProducts }
